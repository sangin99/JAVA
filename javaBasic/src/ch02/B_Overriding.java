...
class SuperClass1 {
	...
	SuperClass1 (int superInstanceVariable) {
		this.superInstanceVariable = superInstanceVariable;     // 저장하는 직접 생성자 생성 - 기본 생성자 . 자동생성자 삭제
	}
...
public class B_Overriding {
	...
	public static void main(String[] args) {
		...
		SuperClass1 instance11 = new SuperClass1(0);
		SubClass1 instance2 = new SubClass1();
		SubClass2 instance3 = new SubClass2(0);
		SubClass2 instance31 = new SubClass2(50);

		instance11.instanceMethod();
		instance2.instanceMethod();
		// instance1.instanceMethod();
		// instance2.instanceMethod();
		instance31.instanceMethod();

		System.out.println(instance11.superInstanceVariable);
		System.out.println(instance2.superInstanceVariable);
		System.out.println(instance31.superInstanceVariable);
