...
class ExampleClass {                       // Class 선언
	...
	// 속성(필드) : 해당 클래스의 객체(인스턴스)가 가질 수 있는 정보나 상태
		//유형
			...
			//클래스 변수(스테틱변수) : 같은 클래스로 생성된 인스턴스가 공유하는 속성 
			//static 키워드를 사용하여 선언
			static int staticVariable;
			// 특징 : 틀래스로 직접 사용할 수 있고, 인스턴스에서도 사용할 수 있음
	...
	//기능(메서드): 해당 클래스가 수행할 수 있는 작업이나 행동 
		...
		//유형
			...
			// 특징 : 인스턴스 변수를 사용할 수 없음 - 인스턴스 변수는 인스턴스 생성 후에 사용 
			//		 일반적으로 인스턴스 변수를 사용하지 않는 기능을 구현할 때
