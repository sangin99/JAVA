...
//=================================================================================		
		// List : 데이터를 저장할 때 중복을 허용하고 순서가 존재(=index 가 있다)
...
//===============================================================================		
		...
		System.out.println(map.get("AApple"));
...
//==============================================================	
		...
		human1.age = 10;
		// name= 홍길동 , address = 부산광역시 진구 , age = 10
		Map<String, Object> human2 = new HashMap<>();      //Object를  넣었기 때문에 제약이 없다.  // 비추천하는 방식 -> class 만들기!
		human2.put("name", "홍길동");
		human2.put("address", "부산광역시 진구");
		human2.put("age", "열살");
										// 이 둘은 같은 값을 반환하는 같은 식이다.
		
		// 문제점 1. 사용 혹은 추가 할때 오타(실수)에 대한 가능성
		human2.get("nman");
		// 문제점 2. 타입의 안정성의 문제 발생 우려
